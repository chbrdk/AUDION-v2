...
| Entity header | `components/admin/section-shell/msqdx-glass-section-entity-header.tsx` — optional `entityCornerAccent`: dekoratives `MsqdxCornerBox` (oben rechts, `cutdown-b`, gleicher Radius wie Subnav-Dock) |
