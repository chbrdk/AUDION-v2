...
@cache
def get_checkion_agent_version() -> str:
	"""Get the browser-use package version using the same logic as Agent._set_checkion_agent_version_and_source"""
	try:
...
async def check_latest_checkion_agent_version() -> str | None:
