...
from checkion_agent.llm.messages import BaseMessage, ContentPartTextParam, SystemMessage
from checkion_agent.llm.schema import SchemaOptimizer
from checkion_agent.llm.vercel.serializer import VercelMessageSerializer
from checkion_agent.llm.views import ChatInvokeCompletion, ChatInvokeUsage
...
class ChatVercel(BaseChatModel):
	...
	Examples:
		```python
	        from checkion_agent import Agent, ChatVercel
