...
import type { TargetGroupListItem } from "@udg-glass/types";

import { MaterialSymbol } from "./material-symbol";

type UdgGlassTargetGroupCardProps = {
  targetGroup: TargetGroupListItem;
  selected?: boolean;
  onSelect?: (targetGroupId: string) => void;
};

export const UdgGlassTargetGroupCard = ({
  targetGroup,
  selected,
  onSelect,
}: UdgGlassTargetGroupCardProps) => {
  return (
    <div
      className={`udg-glass-card ${selected ? "is-selected" : ""}`}
