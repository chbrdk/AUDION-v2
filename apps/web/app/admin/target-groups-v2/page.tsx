...
import { MsqdxGlassTargetGroupsV2Overview } from "../../../components/target-groups-v2/msqdx-glass-target-groups-v2-overview";
...
export default async function TargetGroupsV2AdminPage() {
  ...
  return (
    <>
      ...
      <MsqdxGlassTargetGroupsV2Overview initialList={list} />
    </>
  );
}
