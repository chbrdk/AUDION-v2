...
type UdgGlassPersonaCreateDialogProps = {
  open: boolean;
  onClose: () => void;
...
export const UdgGlassPersonaCreateDialog = ({
  open,
  onClose,
  onSubmit,
  loading = false,
}: UdgGlassPersonaCreateDialogProps) => {
  ...
  return (
    <div
      className="udg-glass-modal-overlay"
      style={{
        position: "fixed",
        top: 0,
        left: 0,
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          <div className="udg-glass-field" style={{ marginBottom: "16px" }}>
          ...
          <div className="udg-glass-field" style={{ marginBottom: "24px" }}>
...
UdgGlassPersonaCreateDialog.displayName = "udg-glass-persona-create-dialog";
