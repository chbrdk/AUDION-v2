...
| &lt;900px | Compact card: menu button (left) opens right **context drawer** with stacked pickers; page title + chat stay **right-aligned** (`margin-left: auto` on `__end`); row clears nav hamburger (`padding-left: 64px + sm`) |
