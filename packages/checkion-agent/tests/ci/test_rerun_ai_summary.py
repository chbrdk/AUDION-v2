...
from checkion_agent.agent.views import ActionResult, AgentHistory, AgentHistoryList, RerunSummaryAction, StepMetadata
from checkion_agent.browser.views import BrowserStateHistory
from checkion_agent.dom.views import DOMRect, NodeType
...
async def test_rerun_cleanup_on_failure(httpserver):
	...
	"""
	from checkion_agent.dom.views import DOMInteractedElement
