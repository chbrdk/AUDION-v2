...
from checkion_agent_sdk.types.parameter_schema import ParameterSchema
from checkion_agent_sdk.types.skill_response import SkillResponse
...
class Skill(BaseModel):
	...
	def parameters_pydantic(self, exclude_cookies: bool = False) -> type[BaseModel]:
		...
		"""
		from checkion_agent.skills.utils import convert_parameters_to_pydantic
	...
	def output_type_pydantic(self) -> type[BaseModel] | None:
		...
		from checkion_agent.skills.utils import convert_json_schema_to_pydantic
