...
type MsqdxGlassUploadDropzoneProps = {
...
export const MsqdxGlassUploadDropzone = ({ onFileSelect, status }: MsqdxGlassUploadDropzoneProps) => {
...
MsqdxGlassUploadDropzone.displayName = "msqdx-glass-upload-dropzone";
