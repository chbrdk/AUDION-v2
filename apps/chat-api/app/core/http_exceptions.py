...
# Optional: pydantic and httpx may not be in all environments
try:
...
def exception_to_http(exc: BaseException, context: str = "Request") -> HTTPException:
    ...
    # Avoid exposing long stack traces or internal paths
    if len(detail) > 200:
        detail = detail[:197] + "..."

    # Validation (e.g. request body)
    ...
    # Upstream HTTP (e.g. OpenAI, Anthropic)
