...
export const UdgGlassTargetGroupAdminPanel = ({
  initialList,
  docsUrl,
}: UdgGlassTargetGroupAdminPanelProps) => {
  ...
  return (
    <div className="udg-glass-admin-grid">
      ...
      <section className="udg-glass-panel">
        ...
        {selectedId && detailLoading && <p className="udg-glass-muted">Loading Target Group...</p>}
        ...
        {detail && (
          <div className="udg-glass-detail">
            ...
            <div className="udg-glass-detail__section">
              ...
              <div className="udg-glass-create-form" style={{ marginTop: "0.75rem" }}>
                <button
                  type="button"
                  className="udg-glass-create-form__header"
                ...
                {personaFormExpanded && (
                  <form onSubmit={handlePersonaSubmit} className="udg-glass-create-form__content">
                    <div className="udg-glass-field">
            ...
            <div className="udg-glass-detail__section">
              ...
              {knowledgeEntries.length === 0 ? (
                <p className="udg-glass-empty">No knowledge entries yet.</p>
              ) : (
                <div className="udg-glass-list">
                  {knowledgeEntries.map((entry) => (
                    <div key={entry.id} className="udg-glass-list-item">
                      <div className="udg-glass-list-item__row">
              ...
              <div className="udg-glass-create-form" style={{ marginTop: "0.75rem" }}>
                ...
                {knowledgeFormExpanded && (
                  <form onSubmit={handleKnowledgeSubmit} className="udg-glass-create-form__content">
                    <div className="udg-glass-field">
                      <label>Titel</label>
                      <input
            ...
            <div className="udg-glass-detail__section">
              <h3 style={{ fontSize: "1.5rem", fontWeight: 100, marginBottom: "2rem", textTransform: "uppercase", letterSpacing: "0.05em" }}>
                ...
                {documents.some((doc) => doc.ingestionStatus === "pending" || doc.ingestionStatus === "processing") && (
                  <span className="udg-glass-muted" style={{ fontSize: "0.75rem", display: "inline-flex", alignItems: "center", gap: "4px", marginLeft: "0.5rem", fontWeight: 400, textTransform: "none" }}>
                    <MaterialSymbol icon="sync" fontSize={14} style={{ animation: "spin 2s linear infinite" }} />
                    Updating...
                  </span>
                )}
              </h3>
              {documents.length === 0 && <p className="udg-glass-empty">No documents uploaded.</p>}
              {documents.length > 0 && (
                <div className="udg-glass-list">
                  {documents.map((doc) => {
                    const ingestionChip = doc.ingestionStatus
                      ? doc.ingestionStatus === "completed"
                        ? { label: "INDEXED", className: "udg-glass-chip --published" }
                        : doc.ingestionStatus === "processing"
                          ? { label: `PROCESSING ${doc.ingestionProgress ? Math.round(doc.ingestionProgress) : 0}%`, className: "udg-glass-chip --pending" }
                          : doc.ingestionStatus === "failed"
                            ? { label: "ERROR", className: "udg-glass-chip --error" }
                            : { label: "PENDING", className: "udg-glass-chip --pending" }
                      : null;
                    return (
                      <div key={doc.id} className="udg-glass-list-item">
                        <div className="udg-glass-list-item__row">
              ...
              <div className="udg-glass-create-form" style={{ marginTop: "0.75rem" }}>
                <button
                  type="button"
                  className={clsx("udg-glass-create-form__header", documentUploadExpanded && "--expanded")}
            ...
            <div className="udg-glass-detail__section">
              <UdgGlassKnowledgeExplorer targetGroupId={selectedId || ""} />
            </div>
          </div>
        )}
      </section>
