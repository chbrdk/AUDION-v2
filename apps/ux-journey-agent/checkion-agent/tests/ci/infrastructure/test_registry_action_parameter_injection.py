...
class TestBrowserContext:
	...
	# 	# Navigate to a test page
	# 	from checkion_agent.browser.events import NavigateToUrlEvent; event = browser_session.event_bus.dispatch(NavigateToUrlEvent(url=f'{base_url}/')
	...
	async def test_custom_action_with_no_arguments(self, browser_session, base_url):
		...
		from checkion_agent.agent.views import ActionResult
