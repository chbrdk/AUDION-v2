...
export type MsqdxGlassDashboardCardProps = {
  id: string;
  title: string;
  icon: string;
...
export const MsqdxGlassDashboardCard = ({
  id,
  title,
  icon,
  variant,
  ...
  return (
    <div className={cardClassName} style={cardStyle}>
      <div 
        className="msqdx-glass-dashboard-card-header"
        style={headerStyle}
      ...
      >
        ...
        <button 
          className={clsx(
            "msqdx-glass-dashboard-card-toggle",
            expanded && "--expanded"
          )}
      ...
      {expanded && (
        <div className="msqdx-glass-dashboard-card-content">
          {children}
        </div>
      )}
    </div>
