...
export type UdgGlassProcessingTimelineProps = {
  activeStage?: string;
};

export const UdgGlassProcessingTimeline = ({ activeStage }: UdgGlassProcessingTimelineProps) => {
...
UdgGlassProcessingTimeline.displayName = "udg-glass-processing-timeline";
