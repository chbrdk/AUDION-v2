...
from checkion_agent.skill_cli.sessions import SessionInfo
...
async def handle(action: str, session: SessionInfo, params: dict[str, Any]) -> Any:
	...
	if action == 'open':
		...
		from checkion_agent.browser.events import ClickElementEvent, TypeTextEvent
		...
		from checkion_agent.browser.events import SendKeysEvent
		...
		from checkion_agent.browser.events import UploadFileEvent
