...
from checkion_agent.browser.cloud.cloud import CloudBrowserAuthError, CloudBrowserClient, CloudBrowserError

# CDP logging is now handled by setup_logging() in logging_config.py
# It automatically sets CDP logs to the same level as checkion_agent logs
from checkion_agent.browser.cloud.views import CloudBrowserParams, CreateBrowserRequest, ProxyCountryCode
from checkion_agent.browser.events import (
...
from checkion_agent.browser.profile import BrowserProfile, ProxySettings
from checkion_agent.browser.views import BrowserStateSummary, TabInfo
from checkion_agent.dom.views import DOMRect, EnhancedDOMTreeNode, TargetInfo
from checkion_agent.observability import observe_debug
from checkion_agent.utils import _log_pretty_url, create_task_with_error_handling, is_new_tab_page

if TYPE_CHECKING:
	from checkion_agent.actor.page import Page
	from checkion_agent.browser.demo_mode import DemoMode
	from checkion_agent.browser.watchdogs.captcha_watchdog import CaptchaWaitResult
...
class BrowserSession(BaseModel):
	...
	def from_system_chrome(cls, profile_directory: str | None = None, **kwargs: Any) -> Self:
		...
		from checkion_agent.skill_cli.utils import find_chrome_executable, get_chrome_profile_path, list_chrome_profiles
		...
		if profile_directory is None:
			if profiles:
				...
				logging.getLogger('checkion_agent').info(
	...
	def list_chrome_profiles(cls) -> list[dict[str, str]]:
		...
		from checkion_agent.skill_cli.utils import list_chrome_profiles
	...
	def logger(self) -> Any:
		...
		# 	self._logger = logging.getLogger(f'checkion_agent.{self}')
		return logging.getLogger(f'checkion_agent.{self}')
	...
	def model_post_init(self, __context) -> None:
		...
		from checkion_agent.browser.watchdog_base import BaseWatchdog
	...
	async def kill(self) -> None:
		...
		from checkion_agent.browser.events import SaveStorageStateEvent
	...
	async def new_page(self, url: str | None = None) -> 'Page':
		...
		from checkion_agent.actor.page import Page as Target
	...
	async def get_pages(self) -> list['Page']:
		...
		# Import here to avoid circular import
		from checkion_agent.actor.page import Page as PageActor
	...
	async def attach_all_watchdogs(self) -> None:
		...
		from checkion_agent.browser.watchdogs.aboutblank_watchdog import AboutBlankWatchdog
		from checkion_agent.browser.watchdogs.captcha_watchdog import CaptchaWatchdog

		# from checkion_agent.browser.crash_watchdog import CrashWatchdog
		from checkion_agent.browser.watchdogs.default_action_watchdog import DefaultActionWatchdog
		from checkion_agent.browser.watchdogs.dom_watchdog import DOMWatchdog
		from checkion_agent.browser.watchdogs.downloads_watchdog import DownloadsWatchdog
		from checkion_agent.browser.watchdogs.har_recording_watchdog import HarRecordingWatchdog
		from checkion_agent.browser.watchdogs.local_browser_watchdog import LocalBrowserWatchdog
		from checkion_agent.browser.watchdogs.permissions_watchdog import PermissionsWatchdog
		from checkion_agent.browser.watchdogs.popups_watchdog import PopupsWatchdog
		from checkion_agent.browser.watchdogs.recording_watchdog import RecordingWatchdog
		from checkion_agent.browser.watchdogs.screenshot_watchdog import ScreenshotWatchdog
		from checkion_agent.browser.watchdogs.security_watchdog import SecurityWatchdog
		from checkion_agent.browser.watchdogs.storage_state_watchdog import StorageStateWatchdog
	...
	async def connect(self, cdp_url: str | None = None) -> Self:
		...
		if not self.cdp_url.startswith('ws'):
			...
			async with httpx.AsyncClient(timeout=httpx.Timeout(30.0), trust_env=not is_localhost) as client:
				...
				from checkion_agent.utils import get_checkion_agent_version

				headers.setdefault('User-Agent', f'browser-use/{get_checkion_agent_version()}')
		...
		try:
			...
			from checkion_agent.browser.session_manager import SessionManager
			...
			from checkion_agent.utils import is_new_tab_page
	...
	async def navigate_to(self, url: str, new_tab: bool = False) -> None:
		...
		"""
		from checkion_agent.browser.events import NavigateToUrlEvent
	...
	async def get_dom_element_at_coordinates(self, x: int, y: int) -> EnhancedDOMTreeNode | None:
		...
		"""
		from checkion_agent.dom.views import NodeType
	...
	def find_file_input_near_element(
		...
		"""
		from checkion_agent.dom.views import EnhancedDOMTreeNode
