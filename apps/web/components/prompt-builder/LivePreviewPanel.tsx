...
export function LivePreviewPanel({ prompt, context, useMockData = false, onTestPrompt, canTest, showButton = true }: LivePreviewPanelProps) {
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "1rem", position: "relative" }}>
        ...
        {!loading && !rendered && !errors.length && (
