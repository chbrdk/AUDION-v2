...
def _check_package() -> dict[str, Any]:
	...
	try:
		...
		version = getattr(checkion_agent, '__version__', 'unknown')
		return {
			'status': 'ok',
...
def _check_cloudflared() -> dict[str, Any]:
	...
	from checkion_agent.skill_cli.tunnel import get_tunnel_manager
...
def _check_profile_use() -> dict[str, Any]:
	...
	from checkion_agent.skill_cli.profile_use import get_profile_use_binary
