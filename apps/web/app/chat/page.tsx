...
// Re-export types and functions from the conversation page
...
// Import the ChatPage component logic from the conversation page
// For now, we'll use the same component but without conversationId
export default function ChatPage() {
  ...
  // Use the same JSX structure as the conversation page
  return (
    <Box
      component="main"
      sx={{
