...
load_dotenv()
from checkion_agent import Agent, AgentHistoryList, BrowserProfile, BrowserSession, ChatBrowserUse
...
async def run_single_task(task_file):
	...
	try:
		...
		for logger_name in ['checkion_agent', 'telemetry', 'message_manager']:
