...
Example:
    from checkion_agent.sandbox import sandbox, SSEEvent, SSEEventType
...
from checkion_agent.sandbox.sandbox import SandboxError, sandbox
from checkion_agent.sandbox.views import (
	BrowserCreatedData,
	ErrorData,
	ExecutionResponse,
	LogData,
