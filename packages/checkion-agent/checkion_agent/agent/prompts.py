...
from checkion_agent.dom.views import NodeType, SimplifiedNode
from checkion_agent.llm.messages import ContentPartImageParam, ContentPartTextParam, ImageURL, SystemMessage, UserMessage
from checkion_agent.observability import observe_debug
from checkion_agent.utils import is_new_tab_page, sanitize_surrogates

if TYPE_CHECKING:
	from checkion_agent.agent.views import AgentStepInfo
...
class SystemPrompt:
	def __init__(
		...
		is_checkion_agent_model: bool = False,
		...
		self.is_checkion_agent_model = is_checkion_agent_model
	...
	def _load_prompt_template(self) -> None:
		...
		try:
			...
			if self.is_checkion_agent_model:
				if self.flash_mode:
					template_filename = 'system_prompt_checkion_agent_flash.md'
				elif self.use_thinking:
					template_filename = 'system_prompt_checkion_agent.md'
				else:
					template_filename = 'system_prompt_checkion_agent_no_thinking.md'
			...
			with (
				importlib.resources.files('checkion_agent.agent.system_prompts')
