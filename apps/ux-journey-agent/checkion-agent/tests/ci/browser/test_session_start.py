...
from checkion_agent.browser.profile import (
	BROWSERUSE_DEFAULT_CHANNEL,
	BrowserChannel,
	BrowserProfile,
)
from checkion_agent.browser.session import BrowserSession
...
class TestBrowserSessionReusePatterns:
	...
	async def test_sequential_agents_same_profile_different_browser(self, mock_llm):
		...
		from checkion_agent import Agent
		from checkion_agent.browser.profile import BrowserProfile
	...
	async def test_sequential_agents_same_profile_same_browser(self, mock_llm):
		...
		from checkion_agent import Agent, BrowserSession
...
class TestBrowserSessionEventSystem:
	...
	async def test_direct_event_dispatching(self, browser_session):
		...
		from checkion_agent.browser.events import BrowserConnectedEvent, BrowserStartEvent
	...
	async def test_event_system_error_handling(self, browser_session):
		...
		from checkion_agent.browser.events import BrowserStartEvent
	...
	async def test_concurrent_event_dispatching(self, browser_session: BrowserSession):
		...
		from checkion_agent.browser.events import ScreenshotEvent
	...
	# 	from checkion_agent import BrowserSession
