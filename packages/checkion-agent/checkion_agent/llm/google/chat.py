...
from checkion_agent.llm.exceptions import ModelProviderError
from checkion_agent.llm.google.serializer import GoogleMessageSerializer
...
class ChatGoogle(BaseChatModel):
	...
	def logger(self) -> logging.Logger:
		...
		return logging.getLogger(f'checkion_agent.llm.google.{self.model}')
