...
from checkion_agent.browser.cloud.views import CloudBrowserParams
from checkion_agent.config import CONFIG
from checkion_agent.utils import _log_pretty_path, logger
...
# Using constants from central location in checkion_agent.config
...
class BrowserProfile(BrowserConnectArgs, BrowserLaunchPersistentContextArgs, BrowserLaunchArgs, BrowserNewContextArgs):
	...
	proxy: ProxySettings | None = Field(
		default=None,
		description='Proxy settings. Use checkion_agent.browser.profile.ProxySettings(server, bypass, username, password)',
	)
